...
#include "FTLTestIndication.h"
#include "FTLTestRequest.h"

FTLTestRequestProxy *device;

typedef unsigned int uint;

class FTLTestIndication : public FTLTestIndicationWrapper
{

	public:
		FTLTestIndication(uint id) : FTLTestIndicationWrapper(id){}
...
int main(int argc, const char **argv)
{
	...
	device = new FTLTestRequestProxy(IfcNames_FTLTestRequestS2H);
	FTLTestIndication deviceIndication(IfcNames_FTLTestIndicationH2S);
