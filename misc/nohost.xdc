...
set_false_path -from [get_clocks -of_objects [get_pins ps7_fclk_0_c/O]] -to [get_clocks bscan_refclk]
set_false_path -from [get_clocks bscan_refclk] -to [get_clocks -of_objects [get_pins ps7_fclk_0_c/O]]
...
#    set_max_delay -from [get_clocks TS_user_clk_i_all] -to [get_clocks -of_objects [get_pins ps7_fclk_0_c/O]] -datapath_only 8.0
#    #CDC from aurora sync clk (TS_sync_clk_i_all) to/from clkgen_pll_CLKOUT0(125MHz clk)
#    #set_max_delay -from [get_clocks -of_objects [get_pins ps7_fclk_0_c/O]] -to [get_clocks TS_sync_clk_i_all] -datapath_only 8.0
#    #set_max_delay -from [get_clocks TS_sync_clk_i_all] -to [get_clocks -of_objects [get_pins ps7_fclk_0_c/O]] -datapath_only 8.0
#    
